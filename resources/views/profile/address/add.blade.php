...
@section('content')
    <section class="container">
        <form action="{{ route('address.add') }}" method='post'>
            @csrf
            <input name="redirect_name" type="hidden"
                value="{{ app('router')->getRoutes(url()->previous())->match(app('request')->create(url()->previous()))->getName() }}" />
            <div
                ...
                <div class="uk-card uk-card-default uk-card-body  uk-padding-large uk-width-2-3@m">
                    ...
                    <div>
                        ...
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                            ...
                            <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                                ...
                                <input class="uk-input" type="number" id="pincode" name="pincode" pattern="[0-9]{6}"
                                    placeholder="6-digit [0-9] PIN code" required>
                            </div>
                        </div>
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                        ...
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                            ...
                            <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                                <select name="state" id="state" class="uk-input uk-select" required>
                        ...
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                            ...
                            <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                                <select name="type" id="type" class="uk-input uk-select" required>
                        ...
                        <div class="uk-flex uk-flex-around">
                            <button type="submit" class="uk-button bg-theme-color1 text-theme-color5">Add Address</button>
                        </div>
                        <br>
                    </div>
                </div>
