        ...
        <div>
            <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                ...
                <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                    ...
                    <input class="uk-input" type="text" id="name" name="name" value="{{ $addr->name }}" required>
                </div>
            </div>
            <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                ...
                <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                    <i class="uk-form-icon ri-pencil-fill"></i>
                    <input class="uk-input" type="number" id="mobile" name="mobile" pattern="[6-9]{1}[0-9]{9}" value={{ $addr->mobile }} placeholder="10-digit mobile number without prefixes" required>
                </div>
            </div>
            <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                ...
                <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                    <i class="uk-form-icon ri-pencil-fill"></i>
                    <input class="uk-input" type="number" id="pincode" name="pincode" pattern="[0-9]{6}" value={{ $addr->pincode }} placeholder="6-digit [0-9] PIN code" required>
                </div>
            </div>
            <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                ...
                <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                    <i class="uk-form-icon ri-pencil-fill"></i>
                    <input class="uk-input" type="text" id="address1" name="address1" value="{{ $addr->address1 }}" required>
                </div>
            </div>
            <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                ...
                <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                    <i class="uk-form-icon ri-pencil-fill"></i>
                    <input class="uk-input" type="text" id="address2" name="address2" value="{{ $addr->address2 }}" required>
                </div>
            </div>
            <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                ...
                <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                    <i class="uk-form-icon ri-pencil-fill"></i>
                    <input class="uk-input" type="text" id="landmark" name="landmark" value="{{ $addr->landmark }}" placeholder="E.g. Near AIIMS Flyover, Behind Regal Cinema, etc." required>
                </div>
            </div>
            <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                ...
                <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                    <i class="uk-form-icon ri-pencil-fill"></i>
                    <input class="uk-input" type="text" id="city" name="city" value="{{ $addr->city }}" required>
                </div>
            </div>
            <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
