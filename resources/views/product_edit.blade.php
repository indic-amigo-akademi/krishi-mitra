            ...
            <div class="uk-card uk-card-default uk-card-body uk-width-2-3@m">
                ...
                <div class="uk-padding-small uk-flex uk-flex-middle">
                    ...
                    <div class="uk-inline uk-width-4-5">
                        ...
                        <input class="uk-input" type="text" id="type" name="type" value={{ $prod->type }}>
                    </div>
                </div>
                <div class="uk-padding-small uk-flex uk-flex-middle">
                    ...
                    <div class="uk-inline uk-width-4-5">
                        <a class="uk-form-icon ri-pencil-fill" href="#"></a>
                        <input class="uk-input" type="text" id="name" name="name" value={{ $prod->name }}>
                    </div>
                </div>
                <div class="uk-padding-small uk-flex uk-flex-between uk-flex-middle">
                    <div>
                        ...
                        <div class="uk-inline">
                            <a class="uk-form-icon ri-pencil-fill" href="#"></a>
                            <input class="uk-input" type="string" id="unit" name="unit" value={{ $prod->unit }}>
                        </div>
                    </div>
                    <div>
                ...
                <div class="uk-padding-small uk-flex uk-flex-middle">
                    ...
                    <div class="uk-inline uk-width-4-5">
                        <textarea class="uk-textarea" rows="5" id="desc" name="desc">{{ $prod->desc }}</textarea>
                    </div>
                </div>
