        ...
        <form action="{{ route('address.edit') }}" method='post' enctype="multipart/form-data">
            ...
            <div
                ...
                <div class="uk-card uk-card-default uk-card-body uk-padding-large uk-width-2-3@m">
                    <h1 class="uk-heading-divider uk-text-center uk-text-bold cproduct-head">Edit Address</h1>
                    <div>
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                            ...
                            <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                                ...
                                <input class="uk-input" type="text" id="name" name="name" value="{{ $addr->name }}"
                                    required>
                            </div>
                        </div>
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                            ...
                            <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                                <i class="uk-form-icon ri-pencil-fill"></i>
                                <input class="uk-input" type="number" id="mobile" name="mobile" pattern="[6-9]{1}[0-9]{9}"
                                    value={{ $addr->mobile }} placeholder="10-digit mobile number without prefixes"
                                    required>
                            </div>
                        </div>
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                            ...
                            <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                                <i class="uk-form-icon ri-pencil-fill"></i>
                                <input class="uk-input" type="number" id="pincode" name="pincode" pattern="[0-9]{6}"
                                    value={{ $addr->pincode }} placeholder="6-digit [0-9] PIN code" required>
                            </div>
                        </div>
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                            <label class="uk-width-1-5@m uk-text-bold" for="address1">Flat, House no., Building, Company,
                                Apartment :</label>
                            <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                                <i class="uk-form-icon ri-pencil-fill"></i>
                                <input class="uk-input" type="text" id="address1" name="address1"
                                    value="{{ $addr->address1 }}" required>
                            </div>
                        </div>
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                            <label class="uk-width-1-5@m uk-text-bold" for="address2">Area, Colony, Street, Sector, Village
                                :</label>
                            <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                                <i class="uk-form-icon ri-pencil-fill"></i>
                                <input class="uk-input" type="text" id="address2" name="address2"
                                    value="{{ $addr->address2 }}" required>
                            </div>
                        </div>
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                            ...
                            <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                                <i class="uk-form-icon ri-pencil-fill"></i>
                                <input class="uk-input" type="text" id="landmark" name="landmark"
                                    value="{{ $addr->landmark }}"
                        ...
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                            ...
                            <div class="uk-inline uk-width-1-1 uk-width-4-5@m">
                                <i class="uk-form-icon ri-pencil-fill"></i>
                                <input class="uk-input" type="text" id="city" name="city" value="{{ $addr->city }}"
                                    required>
                            </div>
                        </div>
                        <div class="uk-padding-small uk-flex uk-flex-middle uk-flex-wrap">
                        ...
                        <div class="uk-flex uk-flex-around">
                            ...
                            <button type="submit" class="uk-button cproduct-btn">Save Address</button>
                        </div>
                        <br>
                    </div>
                </div>
